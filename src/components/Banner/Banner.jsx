    ...
    return (
        <div className="container mx-auto mb-24">
            <div className="flex flex-col md:flex-row justify-around items-center bg-[#1313130D] rounded-2xl py-20 mt-12 mx-4">
                <div className="order-2 md:order-1 lg:flex-none flex flex-col items-center">
                    <h1 className="lg:w-[526px] text-2xl md:text-6xl font-bold text-center">Books to freshen up your bookshelf</h1>
